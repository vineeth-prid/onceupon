...
LAYOUT RULES (for a 16-page book):
...
- Use at least 5 different layout types across the 16 pages for visual variety
- Page 16 (final page) should be "full-bleed-text-center" or "full-bleed-text-bottom" for the warm conclusion
- Use "dramatic-image-only" at most twice, only for the most dramatic/climactic moments
- Use "text-heavy-vignette" for 1-2 reflective or transitional moments
- Alternate between "image-left-text-right" and "image-right-text-left" for quieter scenes
