...
export const FullBleedTextBottom = forwardRef<HTMLDivElement, LayoutPageProps>(
  ({ page }, ref) => (
    <div ref={ref} className="book-page" style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden', background: COLORS.cream }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(to top, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.88) 55%, rgba(255,255,255,0) 100%)',
        padding: '2.5rem 1.3rem 1rem',
      }}>
        <div style={{ width: 30, height: 1, background: COLORS.gold, margin: '0 auto 0.6rem', opacity: 0.5 }} />
