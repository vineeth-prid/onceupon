...
export const ImageRightTextLeft = forwardRef<HTMLDivElement, LayoutPageProps>(
  ({ page }, ref) => {
    ...
    return (
      <div ref={ref} style={{
        ...
        <div style={{
          width: '100%', height: '42%', background: COLORS.warmWhite,
          padding: '1rem 1.3rem',
          ...
          <div style={{ position: 'absolute', bottom: '0.3rem', left: '0.5rem', fontSize: '0.6rem', color: COLORS.inkFaint, fontFamily: FONTS.system }}>
            {page.pageNumber}
          </div>
        </div>
