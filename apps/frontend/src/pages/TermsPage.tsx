...
export function TermsPage() {
  return (
    <LegalLayout
      ...
      intro="Please read these Terms of Use carefully before using the Platform."
    >
      <p>
      ...
      <p>
        ...
        (&lsquo;Website&rsquo;), including the related mobile site and mobile
        application (hereinafter referred to as &lsquo;Platform&rsquo;).
      </p>

      <p>
        The Platform is owned by Endurlink Solutions Pvt. Ltd., a company
        incorporated under the Companies Act, 1956 with its registered office
        at No. 85, Shiradi Avenue, Mettupalayam, Coimbatore &ndash; 641301
        (hereinafter referred to as &lsquo;Platform Owner&rsquo;,
      ...
      <p>
        ...
        (collectively, &ldquo;Services&rdquo;). Any conditions proposed by You
      ...
      <p>
        ...
        requires, &lsquo;you&rsquo;, &lsquo;your&rsquo; or &lsquo;user&rsquo;
      ...
      <ol>
        <li>
          ...
          shall be responsible for all acts done using your registered account
          on the Platform.
        </li>
        <li>
        ...
        <li>
          ...
          contents include and are not limited to the design, layout, look and
          graphics.
        </li>
        <li>
        ...
        <li>
          ...
          actions including reasonable attorney&rsquo;s fees, made by any third
