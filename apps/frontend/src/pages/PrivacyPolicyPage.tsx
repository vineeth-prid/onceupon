...
export function PrivacyPolicyPage() {
  return (
    <LegalLayout
      ...
      intro="How Endurlink Solutions Pvt. Ltd. collects, uses, shares and protects your information."
    >
      <h2>Introduction</h2>
      <p>
        This Privacy Policy describes how Endurlink Solutions Pvt. Ltd. and its
        affiliates (collectively &ldquo;Endurlink Solutions Pvt. Ltd., we, our,
        us&rdquo;) collect, use, share, protect or otherwise process your
        information/personal data through our website{' '}
        <a href="https://gifts.doode.in/" target="_blank" rel="noopener noreferrer">
          https://gifts.doode.in/
        </a>{' '}
      ...
      <p>
        ...
        behavior, preferences, and other information that you choose to provide
        on our Platform. This information is compiled and analyzed on an
        aggregated basis. We will also collect your information related to your
        transactions on the Platform and such third-party business partner
        ...
        person/association claiming to be Endurlink Solutions Pvt. Ltd. seeking
        any personal data like debit/credit card PIN, net-banking or mobile
        banking password, we request you to never provide such information. If
        you have already revealed such information, report it immediately to an
        appropriate law enforcement agency.
      </p>

      <h2>Usage</h2>
      <p>
        We use personal data to provide the services you request. To the extent
        ...
        against error, fraud and other criminal activity; enforce our terms and
        conditions; conduct marketing research, analysis and surveys; and as
      ...
      <p>
        ...
        explicitly opt-out. We may disclose personal data to third parties such
        as sellers, business partners, third party service providers including
        logistics partners, prepaid payment instrument issuers, third-party
        reward programs and other payment options opted by you. These
        ...
        agencies or other authorized law enforcement agencies if required to do
        ...
        that such disclosure is reasonably necessary to: enforce our Terms of
        Use or Privacy Policy; respond to claims that an advertisement, posting
      ...
      <p>
        ...
        against unauthorized access and offer the use of a secure server.
      ...
      <p>
        ...
        any other services, refuse or delay deletion of the account. Once the
        account is deleted, you will lose access to the account. We retain your
        personal data information for a period no longer than is required for
      ...
      <p>
        ...
        your information on the Platform in accordance with this Privacy
        ...
        contact you through SMS, instant messaging apps, call and/or e-mail for
        the purposes specified in this Privacy Policy. You have an option to
        ...
        mention &ldquo;Withdrawal of consent for processing personal
        data&rdquo; in the subject line of your communication. We may verify
      ...
      <p>
        ...
        may alert / notify you about the significant changes to the Privacy
        Policy, in the manner as may be required under applicable laws.
      </p>

      <h2>Grievance Officer</h2>
      <div className="legal-card">
        <p><strong>Name:</strong> Rakesh V Gopi</p>
        <p><strong>Designation:</strong> Creative Head</p>
        <p>
          <strong>Company:</strong> Endurlink Solutions Pvt. Ltd., Prestige
          Cube, Koramangala, Bengaluru, Karnataka, India.
        </p>
        <p><strong>Phone:</strong> +91 80890 00123</p>
        <p><strong>Hours:</strong> Monday &ndash; Friday (9:00 &ndash; 18:00)</p>
      </div>
    </LegalLayout>
  );
}
