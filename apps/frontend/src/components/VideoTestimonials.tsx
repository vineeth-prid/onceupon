...
function NavArrow({ direction, onClick }: { direction: 'left' | 'right'; onClick: () => void }) {
  return (
    ...
    >
      ...
      >
        <path d="M9 5L16 12L9 19" stroke="#333" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </button>
  );
}
          ...
          {TESTIMONIALS.map((t, i) => (
            <div key={t.id} className="video-testi-card">
              ...
              <div style={{
                ...
                <p className="font-body" style={{ fontSize: 16, fontWeight: 700, color: '#fff', marginBottom: 3, letterSpacing: '-0.02em' }}>
                  {t.name}
                </p>
                <p className="font-body" style={{ fontSize: 13, fontWeight: 500, color: 'rgba(255,255,255,0.75)' }}>
                  {t.occasion}
                </p>
              </div>
            </div>
